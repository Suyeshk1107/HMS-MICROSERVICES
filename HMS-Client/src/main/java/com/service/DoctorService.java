...
public class DoctorService {
	...
	@CircuitBreaker(name = "doctor",fallbackMethod ="showAllDoctorFallBack" )
	...
	public DoctorList showAllDoctorFallBack(Exception e) {
		...
		docList.add(new Doctor(null,"no name","no department",0,"no gender",0,"no contact","no address"));
...
//		return new Doctor();
	...
	@CircuitBreaker(name = "doctor",fallbackMethod ="addDoctorFallBack" )
...
//		return new Doctor();
	...
	@CircuitBreaker(name = "doctor",fallbackMethod ="deleteDoctorFallBack" )
	...
	public Doctor deleteDoctorFallBack(Exception e) {
		return new Doctor(null,"no name","no department",0,"no gender",0,"no contact","no address");
//		return new Doctor();
	}
}
